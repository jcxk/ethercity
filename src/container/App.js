...
import addHouse from "../actions/city";
    ...
    <div>
      ...
      <Scene>
        <a-assets>
           ...
           <img alt="grpund" id="groundTexture" src="https://cdn.aframe.io/a-painter/images/floor.jpg"/>
...
return [
 <Entity  position={item.pos} scale="0.01 0.01 0.01" obj-model="obj: #road_asset_obj; mtl: #road_asset_mtl;" ></Entity>,
 <Entity  position={item.pos} scale="0.01 0.01 0.01" obj-model="obj: #grass_obj; mtl: #grass_mtl;" ></Entity>,
 <Entity  position={item.pos} scale="0.004 0.004 0.004" obj-model={objModel} ></Entity>
]})}

        </Entity>

    <a-entity id="cameraWrapper" position="-1.4 1.41 2.92" rotation="-12.834254610930437 -16.844959176846217 0">
